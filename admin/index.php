...
<head>
  ...
  <title>Dashboard | DPMGLangsa</title>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <?php 
          ...
          <?php }else { ?>
            <img src="./assets/dist/img/nasa.jpg" class="img-circle elevation-2" alt="User Image">
          <?php } ?>
        </div>
        <div class="info">
          <?php 
          if($_SESSION['level'] == 2) { ?>
            <a href="#" class="d-block"><?= $penduduk->get_detail_penduduk($nik, "nama_lengkap");?></a>
          <?php }else { ?>
            <a href="#" class="d-block">Nasa Putri Madinah</a>
          <?php } ?>
        </div>
      </div>
